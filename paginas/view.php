<?php
	...
	if($anuncioDao->existeAnuncio($_SESSION['idCadastro']) == false ){
		?>
			<script type="text/javascript">
				alert("Você ainda não possui anuncio cadastrado!");
	...
	foreach($anuncioDao->retornarAnuncio($_SESSION['idCadastro']) as $view){
?>		
<div class="row">
	<div class="col-md-12">
...
<?php
	$i = 0;
	$lista = array();
	foreach($anuncioDao->retornarGaleria($view['idAnuncio']) as $imagem){
